...
extension ShapeCell {
    ...
    static func makeDefaultInfos() -> [ShapeCell.Info] {
        return [
            ...
            ShapeCell.Info(title: "Rectangle",
    ...
    private static func makePolygon(sides: Int, center: CGPoint = shapeCenter, radius: CGFloat = shapeRadius,
        offset: CGFloat = 0) -> UIBezierPath
    {
